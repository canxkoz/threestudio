...
```sh
# uses DeepFloyd IF, requires ~15GB VRAM to extract text embeddings and ~10GB VRAM in training
python launch.py --config configs/magic3d-coarse-if.yaml --train --gpu 0 system.prompt_processor.prompt="a horse"
# uses StableDiffusion, requires ~6GB VRAM in training
...
#cow
python launch.py --config configs/magic3d-refine-sd.yaml --train --gpu 1 system.prompt_processor.prompt="cow" system.from_coarse=/auto/data2/canxkoz/gan_project/threestudio/outputs/magic3d-coarse-sd/cow@20230517-150849/ckpts/last.ckpt
#pigs
...
python launch.py --config configs/magic3d-refine-sd.yaml --train --gpu 0 system.prompt_processor.prompt="cow" system.from_coarse=path/to/coarse/stage/trial/ckpts/last.ckpt system.coarse_geometry_override.isosurface_threshold=10.
```
